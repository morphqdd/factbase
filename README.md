...
```text
                                                                   user
void scan                                                      0.001826
20k facts: export: 2974KB                                      0.863451
20k facts: import: 2974KB                                      1.008353
50k facts: read                                                0.000135
50k facts: read in txn                                         0.002391
50k facts: insert                                              0.000105
50k facts: insert in txn                                       0.000214
50k facts: modify                                              1.035546
50k facts: modify in txn                                       2.252213
12k facts: large query: match 3k                              13.466369
12k facts: large query: match 3k in txn                       18.611751
12k facts: large query: match zero                            14.089012
12k facts: large query: match zero in txn                     19.514022
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-04-29 at 14:13,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/25113889091
